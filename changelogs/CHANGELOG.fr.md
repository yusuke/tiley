...
- Le menu au survol du badge de lien d'un groupe de fenêtres comporte désormais un troisième bouton à côté de celui de permutation : **Aligner la hauteur des fenêtres** (pour les paires gauche/droite, icône flèches haut/bas) ou **Aligner la largeur des fenêtres** (pour les paires haut/bas, icône flèches gauche/droite). Il étend la dimension perpendiculaire au bord de contact des deux fenêtres pour qu'elles couvrent la même enveloppe extérieure, en agrandissant le côté le plus court jusqu'au plus long (le bord de contact est conservé). Le bouton est masqué quand les deux fenêtres sont déjà alignées sur cet axe
