...
- Il menu di hover sul badge di collegamento di un gruppo di finestre ora include un terzo pulsante accanto a quello di scambio: **Uniforma l'altezza delle finestre** (per le coppie sinistra/destra, icona con frecce su/giù) oppure **Uniforma la larghezza delle finestre** (per le coppie alto/basso, icona con frecce sinistra/destra). Estende la dimensione perpendicolare al bordo condiviso di entrambe le finestre fino all'inviluppo esterno comune, allungando il lato più corto fino a quello più lungo (il bordo di contatto resta invariato). Il pulsante è nascosto quando le due finestre sono già allineate su quell'asse
