...
- O menu ao passar o cursor sobre a insígnia de vínculo de um grupo de janelas agora tem um terceiro botão ao lado do de troca: **Igualar altura das janelas** (para pares esquerda/direita, ícone de setas para cima/baixo) ou **Igualar largura das janelas** (para pares superior/inferior, ícone de setas para esquerda/direita). Ele expande a dimensão perpendicular à borda compartilhada de ambas as janelas até a envoltória externa comum, esticando o lado mais curto até o mais longo (a borda de contato é preservada). O botão fica oculto quando as duas janelas já estão alinhadas nesse eixo
